...
if(isset($_POST['submit']))
	{
		...
		$queryc = "INSERT INTO `auditor`( `auditor_name`, `auditor_email`, `auditor_designation`,  `auditor_username`, `auditor_password`, `auditor_contact`) VALUES ('$n','$e','$d','$un','$p','$c')";
                ...
                <div class="row">
                    ...
                    <ol class="breadcrumb" style="background-color:transparent; float:right; ">
                      ...
                      <li>&nbsp;Add Admin&nbsp;</li>                      
                        ...
                        <div class="col-lg-4">
                        <form action="addauditor.php" method="post">
