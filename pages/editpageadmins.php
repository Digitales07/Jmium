...
if(isset($_POST['submit']))
	{
		...
		$queryc = "UPDATE `admin` SET `name`='$n',`username`='$u',`password`='$p',`admin_contact`='$c',`admin_email`='$email',`admin_designation`='$des' where id='$cid'";
...
<input type='hidden' name='cid'  value=<?php echo $idadmin; ?> >
