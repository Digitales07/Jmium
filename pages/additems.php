...
if(isset($_POST['givea'])&&!isset($_POST['submit']))
	{
	 $lid=0;    
		...
		$queryc = "INSERT INTO auditor( name, recip,purpose) VALUES ( '$n','$r','$p')";
...
else if(isset($_POST['submit']))
	{
		...
		$sql= "UPDATE auditor SET name='$nm',recip='$re',purpose='$p' where id='$idg'";
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="auditor.php"><i class="fa fa-glass fa-fw"></i>auditor</a> 
                        </li>
                ...
                <div class="row">
                    ...
                    <ol class="breadcrumb" style="background-color:transparent; float:right; ">
                      ...
                      <li>&nbsp;Add auditor&nbsp;</li>                      
                        ...
                        <h1 class="page-header">ADD auditor</h1>   
...
$sql3 = "select * from auditor where id =".$lid;
...
<br>
<form>
    <input type="button" class='buttond' value="Done" onclick="window.location.href='auditor.php'" style="background-color: #4CAF50; /* Green */
    border: none;
    color: white;
    padding: 15px 32px;
    text-align: center;
